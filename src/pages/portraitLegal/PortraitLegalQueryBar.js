...
class PortraitLegalQueryBar extends Component {
  componentDidMount() {}
  ...
  render() {
    ...
    return (
      <QueryBarCard onForm={onForm} {...others}>
        <TItem col={8} name="corpName" label="法人名称">
          <Input />
        </TItem>
        <TItem col={8} name="uniqueCode" label="统一社会信用代码" labelCol={12}>
          <Input />
        </TItem>
...
export default PortraitLegalQueryBar;
